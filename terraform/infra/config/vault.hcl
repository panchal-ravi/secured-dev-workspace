...
# External secrets plugins (vault-plugin-secrets-github) are baked into the AMI
# here and registered into the catalog by Terraform. The binary carries
# cap_ipc_lock so it runs under disable_mlock = false.
