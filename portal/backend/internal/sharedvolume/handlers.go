...
func (h *Handlers) List(w http.ResponseWriter, r *http.Request) {
	...
	vols, err := h.svc.List(r.Context(), u.Groups, r.PathValue("name"))
	if err != nil {
		fail(w, r, err)
		return
	}
...
func (h *Handlers) Create(w http.ResponseWriter, r *http.Request) {
	...
	u, _ := auth.UserFrom(r.Context())
	v, err := h.svc.Create(r.Context(), u.Email, u.Groups, r.PathValue("name"), in)
	if err != nil {
		fail(w, r, err)
		return
	}
...
func (h *Handlers) Delete(w http.ResponseWriter, r *http.Request) {
	u, _ := auth.UserFrom(r.Context())
	if err := h.svc.Delete(r.Context(), u.Groups, r.PathValue("name"), r.PathValue("vol")); err != nil {
		fail(w, r, err)
		return
	}
...
// ---- helpers (mirror the projectadmin/projectrole adapters) ----
...
func fail(w http.ResponseWriter, r *http.Request, err error) {
	...
	slog.Error("sharedvolume request failed", "err", err, "request_id", rid, "method", r.Method, "path", r.URL.Path)
